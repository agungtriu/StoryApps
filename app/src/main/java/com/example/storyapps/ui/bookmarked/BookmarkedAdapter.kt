...
class BookmarkedAdapter(private val context: Context) :
    PagingDataAdapter<StoryFavoriteEntity, BookmarkedAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    companion object {
        val DIFF_CALLBACK = object : DiffUtil.ItemCallback<StoryFavoriteEntity>() {
            override fun areItemsTheSame(
                oldItem: StoryFavoriteEntity, newItem: StoryFavoriteEntity
            ): Boolean {
